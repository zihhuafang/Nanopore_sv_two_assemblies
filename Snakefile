...
rule all:
    input:
        ...
        expand(OUTDIR + "/{ref}/sv_combined/filtered/high_conf_{ref}.vcf",ref=REF_GENOMES),
        expand(OUTDIR + "/{ref}/sv_combined/polished/high_conf_{ref}.vcf",ref=REF_GENOMES),
        expand(OUTDIR +  "/{ref}/sv_nopass/sv_merge_nopass.vcf",ref=REF_GENOMES),
